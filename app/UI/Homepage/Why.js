...
export default function Why() {
  ...
  return (
    <section className="px-6 md:px-20 xl:px-32 2xl:px-44 py-16 md:py-20 2xl:py-24 overflow-x-hidden">
      <h2 className="md:w-3/4 xl:w-2/3 text-2xl xl:text-4xl 2xl:text-5xl leading-snug mb-12 xl:mb-24 xl:pt-20">
        {t("header")}
        <span className="font-bold"> Trio Travel? </span>
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3  gap-10 text-center ">
        {/* card1 */}
        <div className="relative p-6 py-10 bg-gradient-to-br from-blue-50 to-red-50 shadow-2xl rounded-2xl">
          <h3 className="text-xl xl:text-2xl 2xl:text-3xl mb-10 font-semibold">
            {t("cards.1.header")}
          </h3>
