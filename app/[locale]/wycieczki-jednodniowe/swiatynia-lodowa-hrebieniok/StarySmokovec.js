    ...
    <div className="py-4 md:py-10 my-16 bg-gray-50">
      <div className=" mx-auto px-4 md:px-10 grid lg:grid-cols-2 gap-10 items-center">
        <div className="order-2 lg:order-1">
          ...
          <p className="text-sm xl:text-base mb-4">{t("offer.1.text")}</p>
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 text-sm sm:text-base text-gray-700">
            <li className="flex items-start gap-3">
              <Mountain className="text-blue-500 w-5 h-5 flex-shrink-0 mt-0.5" />
              {t("offer.1.list.1")}
            </li>
            <li className="flex items-center gap-2">
              <Timer className="text-green-600 w-5 h-5 flex-shrink-0 mt-0.5" /> {t("offer.1.list.2")}
            </li>
            <li className="flex items-center gap-2">
              <Bed className="text-yellow-500 w-5 h-5 flex-shrink-0 mt-0.5" /> {t("offer.1.list.3")}
            </li>
            <li className="flex items-center gap-2">
              <Check className="text-blue-500 w-5 h-5 flex-shrink-0 mt-0.5" /> {t("offer.1.list.4")}
            </li>
          </ul>
